...
var Geometry = (function () {
    ...
    return MoGL.extend('Geometry', {
        ...
        value:(function(){
            var calcNormal, infoCheck, pos, nm, tUV, tCo, tPS; //pss
            calcNormal = (function () {
                var sqr, v1, v2;
                sqr = Math.sqrt,
            ...
            return function Geometry(vertex, tIndex, info) {
                ...
                if (info) {
                    ...
                    for (i = 0, j = vertex.length / len; i < j; i++) {
                        ...
                        tPS.push((vertex[k+info.y]-0.5)*-10, vertex[k+info.z]); // pss
                    }
                ...
                pointsize[this] = new Float32Array(tPS); // pss
