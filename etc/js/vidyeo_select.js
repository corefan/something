...
window.addEventListener('keydown', function (evt){
	if(evt.altKey){
		...
		switch(evt.keyCode){
			case 49: // 1
				if(application && application.mainframe){
					application.mainframe.style.set_background('transparent');
					application.mainframe.childframe.style.set_background('transparent');
				}
				break;
			case 48: // 0 control
			...
			case 79: // O open
				pssVD.select.click();
				break;
			case 33: // pageup - prev play
				pssVD.skip(true);
				break;										
			case 34: // pagedown - next play
				pssVD.skip();
				break;
			case 37: // left : -5sec
			...
			case 38: // up - volume up
				pssVD.volume += 0.1;
				break;
			case 40: // up - volume down
				pssVD.volume -= 0.1;
				break;
			case 96: // 0 - play pause
				if(pssVD.paused){
					pssVD.play();
				}else{
					pssVD.pause();
