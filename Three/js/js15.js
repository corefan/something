(function() {
        ...
        l = function(n, i) {
            ...
            try {
                ...
                var _n = function() {
                    ...
                    Cn = function() {
                        return "histats_counter_" + _n() + "_" + B()
                    },
                    En = function() {
                ...
                r.SC = Dn, r.framed_page = function() {
                    ...
                    if (!r.o_i) {
                        ...
                        if (r.d_s = g(r.d_s), S = S.substr(0, 500), D = g(bn("HstCla")), r.d_fa = g(bn("HstCfa")), g(bn("NoHits") > 0) && cn(), r.d_fa < 1 && (r.d_fa = r.o_n, An("HstCfa", r.d_fa)), r.d_nv = 1, An("HstCla", r.o_n), r.c_on = g(bn("HstCla")), r.c_on > 0) {
                            D > 0 && (A = parseInt(r.o_n - D)), r.d_fa > 0 && (r.d_tf = parseInt(r.o_n - r.d_fa)), r.d_pn = g(bn("HstPn")), r.d_pt = g(bn("HstPt")), r.d_cv = g(bn("HstCnv")), r.d_cs = g(bn("HstCns")), r.d_mu = g(bn("HstCmu")), r.d_pn++, r.d_pt++;
                            var o = 1e3,
                                c = 3600 * o,
                                _ = 24 * c * 30.4,
                                u = 600 * o,
                                f = 45 * o;
                            parseInt(r.o_n - r.d_mu) >= _ && (An("HstCmu", r.o_n), r.d_mu = 0), r.d_mu++, 1 > D || A >= _ ? (r.d_pn = 1, r.d_cv = 1, r.d_pt = 1, r.d_cs = 1) : A > 0 && (c > A ? r.d_nv = 0 : (r.d_pn = 1, r.d_cv++), A > u && r.d_cs++), r.d_cv < 1 && (r.d_cv = 1), 1 == r.d_nv && i.setTimeout(function() {
                                r.track_event("b")
                            }, f), An("HstPn", r.d_pn), An("HstPt", r.d_pt), An("HstCnv", r.d_cv), An("HstCns", r.d_cs)
                        }
                        b(S) && 1 == r.d_nv && 1 > t ? An("c_ref_", Sn(S)) : (b(Rn(Tn("c_ref_" + _n()))) && (S = Rn(Tn("c_ref_" + _n()))), b(S) || (S = "1000")), r.d_op = Tn("c_pd_" + _n()), h(r.d_op) || (r.d_op = 0), r.s_pd > 0 && An("c_pd_", r.s_pd)
                    }
                };
                var jn = function() {
                    r.init(), R = "" + (_n() + "") + ("&@f" + r.ver) + ("&@g" + r.d_nv) + ("&@h" + r.d_pn) + ("&@i" + r.d_cv) + ("&@j" + r.c_on) + ("&@k" + A) + ("&@l" + r.d_pt) + ("&@m" + Sn(r.s_ti)) + ("&@n" + r.imp_v()) + ("&@o" + Sn(S)) + ("&@q" + r.s_pd) + ("&@r" + r.d_op) + ("&@s" + B()) + ("&@t" + Sn(r.s_l)) + ("&@u" + r.d_s) + ("&@v" + Sn(r.s_u))
                };
                r.add_v = function(n, t) {
                    b(n) && b(t) && ("tags" == n && (t = t.split(";").join(",")), r.a_va[g(r.a_va.length)] = Sn(n) + "=" + Sn(t))
                }, r.imp_v = function() {
                    var n = "0";
                ...
                r.load_JScall = Bn, r.mlare = function(n, t) {}, r.load_GIFimg = C, r.load_GIFicon = C, r.load_gifImgOrTopImg = r.load_GIFimg, r.track_hits = function() {
                    an() || (jn(), k() ? (O = "i/" + _n() + ".gif?", r.load_gifImgOrTopImg()) : x() ? (O = B() + ".gif?", r.load_GIFicon()) : G() || L() ? (Nn("1"), O = "0.php?", Bn(), Xn()) : (O = _n() + ".php?", Bn()))
                }, r.track_event = function(n) {
                    r.d_ca > 100 || (R = "" + (_n() + "") + ("&@A" + n + "&@R" + u.ceil(1e5 * u.random())), O = "e.php?", J(), Bn(), r.d_ca++)
                };
                var Fn = function(n) {
                        Nn(n), Xn()
                    },
    ...
    var m = window["Histats"] || {},
        h = window,
        g = "_DEBUG_HISTATS_RESET_PARENT",
        y = "_DEBUG_HISTATS_USE_MOCKED_WINDOW",
        w = "_DEBUG_HISTATS_RETURN_BUILDER",
        I = "_DEBUG_HISTATS_forced";
    o = t(window[g]) && 1 == window[g], s = t(window[y]) && window[y] === !0, a = t(window[w]) && window[w] === !0, r = t(window[I]) && window[I] === !0, r = r || o || s, r && (window["histats_counters_byType"] = window["histats_counters_byType"] || {}, window["histats_counters_byType"][i] = window["histats_counters_byType"][i] || [], window["histats_counters_byType"][i].push(e)), o && (m = {}), s && (h = window["mocked_window"]), r ? window["histatsByName_" + e] = a ? l : l(m, h) : window["Histats"] = l(m, h)
}).call(this);