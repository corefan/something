...
//        this.invoker.add(new Command('createShader', gl.VERTEX_SHADER));
    ...
    gl.enableVertexAttribArray(program.uSampler);         
    
    program.uFlag = gl.getUniformLocation(program, "uFlag");
    gl.enableVertexAttribArray(program.uFlag);  
...
World.prototype.render = function(){
    ...
    if(this.changed.vertex){
        ...
        for(i = 0, len = this.meshes.length; i < len; i++) {
            ...
            if(mesh.material.img){
                this.uv_data = this.uv_data.concat(mesh.geometry.uv);
                ...
                gl.uniform2fv(program.uFlag, [1.0, 1.0]);
                mesh.material.img = null;
            }else{
