...
(function() {
  return function() {
    ...
    this._addCss("Sketch", "accessibility", obj, ["normal"]);
    ...
    this._addCss("Sketch", "color", obj, ["mouseover", "focused"]);
    ...
    this._addCss("Sketch", "font", obj, ["normal"]);
    ...
    this._addCss("Sketch", "gradation", obj, ["normal"]);
    ...
    this._addCss("Sketch", "opacity", obj, ["normal"]);
    ...
    this._addCss("Sketch", "background", obj, ["normal"]);
    ...
    this._addCss("MaskEditControl", "border", obj, ["pushed", "disabled", "readonly"]);
    ...
    this._addCss("Sketch", "color", obj, ["normal"]);
    ...
    this._addCss("Sketch", "align", obj, ["normal"]);
    ...
    this._addCss("Sketch", "bordertype", obj, ["normal"]);
    ...
    this._addCss("Sketch", "cursor", obj, ["normal"]);
    ...
    this._addCss("Sketch", "padding", obj, ["normal"]);
    ...
    this._addCss("Sketch", "shadow", obj, ["normal"]);
    ...
    this._addCss("TextAreaControl", "selectbackground", obj, ["focused"]);
    ...
    this._addCss("TextAreaControl", "selectcolor", obj, ["focused"]);
    ...
    this._addCss("Grid>#controledit", "border", obj, ["mouseover", "disabled"]);
    this._addCss("Grid>#controlmaskedit", "border", obj, ["mouseover", "disabled"]);
    ...
    this._addCss("Edit", "selectbackground", obj, ["normal", "mouseover"]);
    this._addCss("TextArea", "selectbackground", obj, ["normal", "mouseover"]);
    this._addCss("MaskEdit", "selectbackground", obj, ["normal", "mouseover"]);

    obj = new nexacro.Style_color("#333333");
    this._addCss("Edit", "selectcolor", obj, ["normal", "mouseover"]);
    this._addCss("EditControl", "selectcolor", obj, ["normal", "mouseover"]);
    this._addCss("TextArea", "selectcolor", obj, ["normal", "mouseover"]);
    this._addCss("TextAreaControl", "selectcolor", obj, ["normal", "mouseover"]);
    this._addCss("MaskEdit", "selectcolor", obj, ["normal", "mouseover"]);
    this._addCss("MaskEditControl", "selectcolor", obj, ["normal", "mouseover"]);
    this._addCss("Grid>#controledit", "selectcolor", obj, ["normal", "mouseover"]);
    ...
    this._addCss("Edit", "background", obj, ["mouseover", "readonly"]);
    this._addCss("EditControl", "background", obj, ["mouseover", "readonly"]);
    ...
    this._addCss("Grid>#controledit", "background", obj, ["mouseover"]);
    this._addCss("Grid>#controlmaskedit", "background", obj, ["mouseover", "readonly"]);
    ...
    this._addCss("Sketch", "background", obj, ["mouseover", "focused", "readonly"]);
    ...
    this._addCss("Edit", "color", obj, ["mouseover"]);
    this._addCss("EditControl", "color", obj, ["mouseover"]);
    this._addCss("TextArea", "color", obj, ["mouseover"]);
    this._addCss("TextAreaControl", "color", obj, ["mouseover"]);
    this._addCss("MaskEdit", "color", obj, ["mouseover"]);
    this._addCss("MaskEditControl", "color", obj, ["mouseover"]);
    this._addCss("Combo>#comboedit", "color", obj, ["mouseover", "focused"]);
    this._addCss("ComboControl>#comboedit", "color", obj, ["mouseover"]);
    this._addCss("Grid>#controledit", "color", obj, ["mouseover"]);
    this._addCss("Grid>#controlmaskedit", "color", obj, ["mouseover"]);
    ...
    this._addCss("Sketch", "background", obj, ["disabled"]);
    ...
    this._addCss("Sketch", "border", obj, ["disabled"]);
    ...
    this._addCss("Sketch", "color", obj, ["disabled"]);
    ...
    this._addCss("Sketch", "color", obj, ["readonly"]);

    obj = new nexacro.Style_value("#ffffff00");
    this._addCss("EditControl", "selectbackground", obj, ["normal", "mouseover"]);
    this._addCss("TextAreaControl", "selectbackground", obj, ["normal", "mouseover"]);
    this._addCss("MaskEditControl", "selectbackground", obj, ["mouseover"]);
    this._addCss("Grid>#controledit", "selectbackground", obj, ["normal", "mouseover"]);
    ...
    obj = new nexacro.Style_shadow("selectbackgroundt: #ffffff00");
    ...
    this._addCss("PopupMenuControl", "itempadding", obj, ["normal", "mouseover"]);
    ...
    obj = new nexacro.Style_bordertype("normal","0","0","true","true","true","true");
    this._addCss("Menu", "popupitembordertype", obj, ["normal", "mouseover"]);
    ...
    this._addCss("Sketch", "border", obj, ["normal", "readonly"]);

    obj = new nexacro.Style_border("1","solid","#a1a1a1ff","");
    this._addCss("Sketch", "border", obj, ["mouseover", "focused"]);
