(function() {
    return function() {
        ...
        this.on_create = function()
        {
            ...
            // Layout Functions
            //-- Default Layout
            obj = new Layout("default", "", 0, 0, this.PopupDiv00, function(p){} );
            this.PopupDiv00.addLayout(obj.name, obj);

            //-- Default Layout
            obj = new Layout("default", "", 310, 450, this, function(p){} );
        ...
        // User Script
        this.registerScript("PopupDiv_M_move_46792_02.xfdl", function() {
        ...
        this.loadIncludeScript("PopupDiv_M_move_46792_02.xfdl");
