(function() {
    return function() {
        ...
        this.on_create = function()
        {
            ...
            obj = new Button("Button03", "absolute", "574", "49", "77", "40", null, null, this);
            obj.set_taborder("1");
            ...
            // Layout Functions
            //-- Default Layout
            obj = new Layout("default", "", 679, 596, this, function(p){} );
        ...
        // User Script
        this.registerScript("menutest5.xfdl", function() {
        ...
        {  
            ...
            this.PopupMenu00.addEventHandler("ontouch", this.PopupMenu00_ontouch, this);
        ...
        this.loadIncludeScript("menutest5.xfdl");
